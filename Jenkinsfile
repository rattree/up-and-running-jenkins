    ...
    stages {
        ...
        stage('Lacework Vulnerability Scan') {
            ...
            steps {
                ...
                sh "lacework vulnerability container scan https://242313835346.dkr.ecr.us-west-2.amazonaws.com $ECR_REGISTRY_URL/lacework-cli latest --poll --noninteractive --details"
            }
        }
    }
}
